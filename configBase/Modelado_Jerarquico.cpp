...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(wrist), glm::vec3(1.0f, 0.0, 0.0f));
		...
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(Dig1F0), glm::vec3(0.0f, 0.0, 1.0f));
		modelTempD1 = model = glm::translate(model, glm::vec3(0.2f, 0.15f, 0.15f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		...
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(Dig2F0), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.2f, -0.25f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		...
		model = glm::translate(modelTempD1, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(Dig1F1), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.2f, 0.2f));
		...
		model = glm::rotate(model, glm::radians(Dig2F1), glm::vec3(0.0f, 0.0, 1.0f));
		model = glm::translate(model, glm::vec3(0.15f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.2f, 0.2f));

...
void CrearCubos(int number) {
	...
	for (int cont=number; cont >0; cont=cont-1) {
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(x, y, z));
		model = glm::rotate(model, 0.5f, glm::vec3(x, y, z));
...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   model = glm::translate(model, glm::vec3(-1.7f, 0.0f, -1.7f));
		...
		model = glm::rotate(model, 0.5f, glm::vec3(4.0f, 0.0f, 0.7f));
		model = glm::scale(model, glm::vec3(2.0f, 1.3f, 2.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.0f, 3.0f, 0.0f));
		model = glm::rotate(model, 0.5f, glm::vec3(-4.0f, 0.0f, 2.0f));
		model = glm::scale(model, glm::vec3(2.0f, 1.3f, 2.5f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		model = glm::rotate(model, 0.5f, glm::vec3(-4.0f, 3.0f, 2.0f));
